...
cy.get('[data-tb-test-id="explorer-content-area"] div[data-tb-test-id="name-cell"] span>a').contains(/\bCustomer Behavior\b/).click()
...
cy.get('span[data-tb-test-id="data-grid-cell-text"][title="Customer Behavior"]').dblclick()
