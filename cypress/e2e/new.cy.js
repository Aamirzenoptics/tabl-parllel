...
cy.get('[data-tb-test-id="explorer-content-area"] div[data-tb-test-id="name-cell"] span>a').contains(/\bRatio analysis Experience\b/).click()
...
cy.get('span[data-tb-test-id="data-grid-cell-text"][title="Ratio analysis Experience"]').dblclick()
