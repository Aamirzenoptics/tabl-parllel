describe('Publish Tableau Workbook', () => {
    it('should publish a Tableau workbook', () => {
      ...
      const workbookFilePath = `${workbookFileName}`;
  
      // Read the workbook file using cy.fixture() method
      cy.fixture(workbookFilePath, 'binary')
        .then((workbookData) => {
          ...
          cy.request({
            method: 'POST',
            url: `${serverUrl}/api/3.12/sites/${siteId}/workbooks`,
            headers: {
