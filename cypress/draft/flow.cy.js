...
let workbooktyped;
// cy.get('.tb-react-dg-hcols>div:nth-child(11)>div').click()
cy.get('[data-tb-test-id="explorer-content-area"] div[data-tb-test-id="name-cell"] span>a').contains(/\bDividend Innovation\b/).click()
...
cy.get('span[data-tb-test-id="data-grid-cell-text"][title="Dividend Innovation"]').dblclick()
